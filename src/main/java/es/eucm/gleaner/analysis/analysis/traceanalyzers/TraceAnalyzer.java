...
public interface TraceAnalyzer extends Serializable {
    ...
    public static final String ZONE_REACHED_PREFIX = ZONE_PREFIX + "reached_";
    ...
    /**
     * @return a string with a regular expression representing the vars generated by this analyzer
     */
    String getVarsGenerated();
